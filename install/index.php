<?php
/*
 * im copy it for another indian developer and i edit it ,..
 * no time to build new factories db migration it's suck  😫
*/
...
if (!empty($_POST['install'])) {
    ...
    if (empty($ServerErrors)) {
        $file_content =
            '<?php
            define("DBHOST","' . $_POST['sql_host'] . '");
            define("DBUSER","' . $_POST['sql_user'] . '");
            define("DBPASS","' . $_POST['sql_pass'] . '");
            define("DBNAME","' . $_POST['sql_name'] . '");
            define("SITEURL", "' . $_POST['site_url'] . '");
            define("INSTALLED", 1);
            ?>';
        $success = '';
...
<head>
    <meta charset="UTF-8">
    <title>Take Home | Installation</title>
        ...
        <div class="col-md-3">
            <ul class="list-group">
                <li class="list-group-item black-list <?php echo ($page == 'terms') ? 'active-list' : ''; ?>"><i
                            class="fa fa-fw fa-bars"></i> Terms of use
                </li>
                <li class="list-group-item black-list <?php echo ($page == 'req') ? 'active-list' : ''; ?>"><i
                            class="fa fa-fw fa-cog"></i> Requirements
                </li>
                ...
                <li class="list-group-item black-list <?php echo ($page == 'finish') ? 'active-list' : ''; ?>"><i
                            class="fa fa-fw fa-check"></i> Finish
                </li>
            </ul>
        </div>
        <div class="col-md-9">
            <div class="list-group">
                <div class="list-group-item"><i
                            class="fa fa-fw fa-<?php echo $page_icon ?>"></i> <?php echo $page_name ?></div>
                <div class="setting-panel">
                    <?php if ($page == 'terms') { ?>
                        <div class="terms">
                            <h5>LICENSE AGREEMENT: one (1) Domain (site) Install</h5>
                            <br>
                            <b>You CAN:</b><br> 1) Use on one (1) domain only, additional license purchase required for
                            each additional domain.<br> 2) Modify or edit as you see fit.<br> 3) Delete sections as you
                            see fit.<br> 4) Translate to your choice of language.<br>
                            <br><b>You CANNOT:</b> <br>1) Resell, distribute, give away or trade by any means to any
                            third party or individual without permission.<br> 2) Use on more than one (1) domain.
                    ...
                    <?php } else if ($page == 'req') { ?>
                        <div class="req">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    <td>PHP 7.3+</td>
                                    <td>Required PHP version 7.3 or more</td>
                                ...
                                <tr>
                                    <td>cart.sql</td>
                                    <td>Required cart.sql for the installation <small>(Located in ./Script)</small>
                                    </td>
                    ...
                    <?php } else if ($page == 'finish') { ?>
                        <div class="req">
                            <h5>Take Home successfully installed, if you have any qeastion, please let us <a
                                        href="mailto:a.saeed@null.net">know</a></h5>
                            <br>
                    ...
                    <?php } else if ($page == 'installation') { ?>
                        <div class="req">
                            ...
                            <?php } ?>
                            <form action="?page=installation" method="post"
                                  class="form-horizontal install-site-setting">
                                <div class="form-group">
                                    <label class="col-md-3" for="siteName">SQL host name </label>
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="sql_host"
                                               value="<?php echo (!empty($_POST['sql_host'])) ? $_POST['sql_host'] : ''; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3" for="siteTitle">SQL username</label>
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="sql_user"
                                               value="<?php echo (!empty($_POST['sql_user'])) ? $_POST['sql_user'] : ''; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3" for="siteName">SQL password </label>
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="sql_pass"
                                               value="<?php echo (!empty($_POST['sql_pass'])) ? $_POST['sql_pass'] : ''; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3" for="siteTitle">SQL database name</label>
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="sql_name"
                                               value="<?php echo (!empty($_POST['sql_name'])) ? $_POST['sql_name'] : ''; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="site_url"
                                               value="<?php echo (!empty($_POST['site_url'])) ? $_POST['site_url'] : ''; ?>">
                                ...
                                <div class="form-group last-btn">
                                    ...
                                    <div class="col-md-6">
                                        <button type="submit" onclick="Wo_SubmitButton();"
                                                class="btn btn-main" <?php echo ($disabled == true) ? 'disabled' : ''; ?>>
